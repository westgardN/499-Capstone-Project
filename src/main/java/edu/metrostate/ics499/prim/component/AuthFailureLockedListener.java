 ...
 */
@Component
public class AuthFailureLockedListener implements ApplicationListener<AuthenticationFailureLockedEvent> {
    private static final Logger logger = LoggerFactory.getLogger(AuthFailureLockedListener.class);
    ...
    public void onApplicationEvent(AuthenticationFailureLockedEvent event) {
        ...
        logger.info("Failed login using username [" + username + "] due to locked account.");
    }
}
